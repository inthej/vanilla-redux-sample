...
var decreaseBtn = document.querySelector('#decrease'); // Action 타입

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // Action 생성함수 (type 값 필수)
...
render(); // 구독하기 - 스토어 상태가 바뀔때마다 render 함수가 실행되도록 한다

store.subscribe(render); // 디스패치 - 액셜 발생시키기
...
},{"redux":"../node_modules/redux/es/redux.js"}],"../../../../../Users/inthej/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
